...
public class WheelView extends View {
    ...
    private void initResourcesIfNecessary() {
        if (itemsPaint == null) {
            ...
            itemsPaint.setTextSize(TEXT_SIZE * mDisplayMetrics.scaledDensity);
            //itemsPaint.setTextSize(getWidth() / 8);
        }
        ...
        if (valuePaint == null) {
            ...
            valuePaint.setTextSize(TEXT_SIZE * mDisplayMetrics.scaledDensity);
