...
import com.zkteco.zkteco.view.kankan.wheel.widget.DateObject;
import com.zkteco.zkteco.view.kankan.wheel.widget.OnWheelChangedListener;
import com.zkteco.zkteco.view.kankan.wheel.widget.StringWheelAdapter;
import com.zkteco.zkteco.view.kankan.wheel.widget.WheelView;
...
public class DatePick extends LinearLayout {
	...
	private void init(Context context){
		...
		LayoutParams newDays_param = new LayoutParams(600,240);
