...
import com.zkteco.zkteco.view.DatePick;
import com.zkteco.zkteco.view.TimePicker;
...
public class PopWindowManager {
    public static void popListWindow(Context context, View view, ArrayList list) {
        ...
        MListViewAdpater adpater = new MListViewAdpater(context.getApplicationContext());
